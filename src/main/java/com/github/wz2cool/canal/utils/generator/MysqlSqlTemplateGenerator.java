...
import com.github.wz2cool.canal.utils.converter.mysql.MysqlEnhancedAlterSqlConverter;
...
public class MysqlSqlTemplateGenerator extends AbstractSqlTemplateGenerator {
    ...
    public MysqlSqlTemplateGenerator(boolean useEnhancedConverter) {
        this.alterSqlConverter = useEnhancedConverter ? new MysqlEnhancedAlterSqlConverter() : new MysqlAlterSqlConverter();
